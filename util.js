...
let Util = {
    ...
    newShowDiff(content1, content2, lineChange){
    ...
    showDiff(files, diff, columns){
        ...
        return Util.newShowDiff(diff.data1, diff.data2, diff.line);
        ...
        // return Util.newShowDiff(lefts, rights);
